            ...
            <form action="update.php" method="post">
                ...
                <div class="mb-3">
                   ...
                   <select name="jabatan" id="">
                    ...
                    <option <? echo ($data['jabatan'] == "Full Time") ? 'selected' :'' ?> value="Full Time">Full Time</option>
                    <option <? echo ($data['jabatan'] == "Part Time") ? 'selected' :'' ?> value="Part Time">Part Time</option>
                   </select>
                </div>
                <div class="mb-3">
